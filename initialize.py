...
def initialize():
    ...
    #chat_llm = models.get_nvidia_chat(model_name="meta/llama-3.1-70b-instruct", temperature=0)
    ...
    #embedding_llm = models.get_jina_embedding(model_name="jina-embeddings-v3")
    # agent configuration
    config = AgentConfig(
        chat_model = chat_llm,
